...
common_params_context common_params_parser_init(common_params & params,
    ...
    add_opt(common_arg({ "--no-warmup" },
                ...
                .set_examples(
                    { LLAMA_EXAMPLE_MAIN, LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_EMBEDDING, LLAMA_EXAMPLE_RETRIEVAL }));
    ...
    add_opt(common_arg({ "--cpu-moe", "-cmoe" },
    ...
    add_opt(common_arg({ "--n-cpu-moe", "-ncmoe" },
                       "N",
    ...
    add_opt(common_arg({ "--parse-special" },
                       string_format("prase special tokens (chat, tool, etc) (default: %s)",
    ...
    add_opt(common_arg({ "--embd-separator" },
                ...
                .set_examples({ LLAMA_EXAMPLE_EMBEDDING }));
    add_opt(common_arg({ "--cls-separator" },
                       "STRING",
    ...
    add_opt(common_arg({ "--chat-template-kwargs" },
                       "STRING",
    ...
    add_opt(common_arg({ "--reasoning-format" },
                       ...
                       "- deepseek: puts thoughts in `message.reasoning_content` (except in streaming mode, which "
                       "behaves as `none`)\n"
                       "(default: auto)",
                       [](common_params & params, const std::string & value) {
                           /**/ if (value == "deepseek") {
                               params.reasoning_format = COMMON_REASONING_FORMAT_DEEPSEEK;
                           } else if (value == "deepseek-legacy") {
    ...
    add_opt(common_arg({ "-devd", "--device-draft" },
                ...
                .set_examples({ LLAMA_EXAMPLE_SPECULATIVE, LLAMA_EXAMPLE_SERVER }));
    add_opt(
        common_arg({ "-ngld", "--gpu-layers-draft", "--n-gpu-layers-draft" },
                   "N",
    ...
    add_opt(common_arg({ "--spec-replace" },
                       "TARGET",
                       "DRAFT",
                ...
                .set_examples({ LLAMA_EXAMPLE_SPECULATIVE, LLAMA_EXAMPLE_SERVER }));
    add_opt(common_arg({ "-ctkd", "--cache-type-k-draft" },
                       "TYPE",
    ...
    add_opt(common_arg({ "-ctvd", "--cache-type-v-draft" },
                       "TYPE",
    ...
    add_opt(common_arg({ "--diffusion-steps" },
                       "N",
    ...
    add_opt(
        common_arg({ "--diffusion-eps" },
                   "F",
                   string_format("epsilon for timesteps (default: %.6f)", (double) params.diffusion.eps),
                   [](common_params & params, const std::string & value) { params.diffusion.eps = std::stof(value); })
            .set_examples({ LLAMA_EXAMPLE_DIFFUSION }));
    add_opt(common_arg({ "--diffusion-algorithm" },
                       "N",
    ...
    add_opt(common_arg({ "--diffusion-block-length" },
                       "N",
    ...
    add_opt(
        common_arg(
            ...
            .set_examples({ LLAMA_EXAMPLE_DIFFUSION }));
    add_opt(common_arg({ "--diffusion-add-gumbel-noise" },
                       "F",
